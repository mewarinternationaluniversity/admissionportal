...
<p class="text-muted mb-1">Enter your <b class="text-danger">NIN or ND Matriculation Number</b> & D.O.B to access portal.</p>
...
<form method="POST" action="{{ route('login') }}">
    ...
    <div class="mb-2">
        <label for="matriculation_no" class="form-label">{{ __('NIN or ND Matriculation Number') }}</label>
