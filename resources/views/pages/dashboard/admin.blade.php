            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h3 class="my-1 py-1"> USD <span data-plugin="counterup">{{ $data['totalpayments'] }}</span></h3>                        
                    </div>
                    <div class="avatar-sm">
                        <span class="avatar-title bg-soft-primary rounded">
                            <i class="ri-hand-heart-line font-20 text-primary"></i>
                ...
                <div class="d-flex justify-content-between">
                    <div>
                        <h5 class="text-muted fw-normal mt-0 text-truncate" title="Number of pending payments">
                            Number of pending applications for approval
                        </h5>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-2">
                    <div class="col-sm-8">
                        <h4 class="page-title">Bachelors Institute Course Mapping</h4>
                    </div>
                    <div class="col-sm-4">
                        <div class="text-sm-end">
