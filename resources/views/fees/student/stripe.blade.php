                    ...
                    <div class="col-xl-8">                        
                        ...
                        <div id="checkout-nav-pills-wizard" class="twitter-bs-wizard form-wizard-header">
                            ...
                            <form 
                                ...
                                <input type="hidden" name="id" value="{{ $fee->id }}" id="id">
                                                ...
                                                <div class="row mt-4">
                                                    <div class="col-md-12">
                                                        <div class="mb-2 form-group required">
                                                            ...
                                                            <input type="text" value="4242424242424242" id="card-number" class="form-control card-number" data-toggle="input-mask" data-mask-format="0000 0000 0000 0000" placeholder="4242 4242 4242 4242">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-2 form-group cvc required">
                                                            ...
                                                            <input value="123" type="text" id="card-cvv" class="form-control card-cvv" data-toggle="input-mask" data-mask-format="000" placeholder="012">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-2 form-group expiration required">
                                                            ...
                                                            <input type="text" value="09" id="card-expiry-month" class="form-control card-expiry-month" data-toggle="input-mask" data-mask-format="00" placeholder="MM">
                                                            <div class="invalid-feedback">This field required.</div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="mb-2 form-group expiration required">
                                                            ...
                                                            <input type="text" value="2029" id="card-expiry-year" class="form-control card-expiry-year" data-toggle="input-mask" data-mask-format="0000" placeholder="YYYY">
                                                            <div class="invalid-feedback">This field required.</div>
                                                        </div>
                                                    </div>
                                                </div> <!-- end row -->
                                    ...
                                    <table class="table table-centered table-nowrap mb-0">
                                        <tbody>
                                            <tr>
                                                <td>Application</td>
                                                <td>Fee</td>
                                                <td class="text-end">USD {{ $amount }}</td>
                                            </tr>
                                            <tr class="text-end">
                                                <td colspan="2">
                                            ...
                                            <tr class="text-end">
                                                ...
                                                <td class="text-end fw-semibold">USD {{ $amount }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
